    ...
    <ContentCard>
      <HeadingContainer>
        ...
        <ContentContainer>
          ...
          <ContentSection>
            Utilizing the latest technology to build
            lightning fast webpages, apps and stores.
            Including user authentication, security,
            Ecommerce, and other exciting features.
            <ul>
              <li>
              ...
              <li>
                ...
                'brain' of nearly all modern websites.
                Without this wonderful language, the website
                you are viewing would be a blank screen.
              </li>
              <li>
